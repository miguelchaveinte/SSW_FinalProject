                ...
                <div class="cursos">
                    ...
                    <div class="slick-list" id="slick-list">
                        ...
                        <div class="slick-track" id="track">
                            <%--ArrayList<Integer> probando = (ArrayList<Integer>)request.getAttribute("cursosGratuitos");--%>
                            <%
                            ...
                            a.add(1);
                            a.add(1);
                            ArrayList<Integer> probando = (ArrayList<Integer>)request.getAttribute("cursosFavoritos");
                            %>
                                ...
                                <div class="slick">
                                    <div>
                                        ...
                                        <a href="accederCurso?idCurso=${cursoGratuito}">
                                            <picture>
                                                <img  alt="Imagen" src="imagenCurso?id=1">
                                            </picture>
                                        </a>
                                    </div>
                                </div>
